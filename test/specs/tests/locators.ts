describe('Locators - Test Scenarios',async ()=>{
    ...
    it('CSS example', async () => {
        ...
        expect(linkResponse).toHaveTextContaining('Link has responded with staus 201 and status text Created')
    ...
    it('CSS by index example(nth-child)', async () => {
        ...
        linkResponse.scrollIntoView()
        expect(linkResponse).toHaveTextContaining('Link has responded with staus 401 and status text Unauthorized')
    })
    ...
    it('Link Text(=) example', async () => {
        ...
        noContentLink.click()
        linkResponse.scrollIntoView()
        expect(linkResponse).toHaveTextContaining('Link has responded with staus 204 and status text No Content')
    })
    ...
    it('Partial Link Text(*=) example', async () => {
        ...
        linkResponse.scrollIntoView()
        expect(linkResponse).toHaveTextContaining('Link has responded with staus 400 and status text Bad Request')
    })
    ...
    it('Element with certain text(<element>={text}) example', async () => {
        ...
        linkResponse.scrollIntoView()
        expect(linkResponse).toHaveTextContaining('Link has responded with staus 403 and status text Forbidden')
    })
    ...
    it('Element with patial text(<element>*={text}) example', async () => {
        ...
        linkResponse.scrollIntoView()
        expect(linkResponse).toHaveTextContaining('Link has responded with staus 301 and status text Moved Permanently')
    })
    ...
    it('Element with xpath example', async () => {
        ...
        linkResponse.scrollIntoView()
        expect(linkResponse).toHaveTextContaining('Link has responded with staus 404 and status text Not Found')
    })
